package cn.pcbc.www.base.component.NineGridView;
    ...
    private void layoutImageView(RatioImageView imageView, int i, String url, boolean showNumFlag) {
        ...
        if (showNumFlag) {
            ...
            if (overCount > 0) {
                ...
                textView.setPadding(0, singleHeight / 2 - getFontHeight(textSize)*2, 0, 0);
...
//        params.width = width;
    ...
    protected abstract void onClickImage(int position, String url, ArrayList<String> urlList ,View view);
}
